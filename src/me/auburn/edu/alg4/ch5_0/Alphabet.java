...
//        StdOut.println(encoded1[5]);
 
//        int[]  encoded2 = Alphabet.DNA.toIndices("AACGAACGGTTTACCCCG");
//        String decoded2 = Alphabet.DNA.toChars(encoded2);
//        StdOut.println(Arrays.toString(encoded2));
//
//        int[]  encoded3 = Alphabet.DECIMAL.toIndices("01234567890123456789");
//        String decoded3 = Alphabet.DECIMAL.toChars(encoded3);
//        StdOut.println(decoded3);
//    	Alphabet a = new Alphabet("abcdefghijklmnopq");
//    	System.out.println(a.toChar(1));
//    	System.out.println(a.toIndex('f'));
//    	System.out.println(a.contains('f'));
//    	System.out.println(a.lgR());
//    	System.out.println(Arrays.toString(a.toIndices("afqc")));
//    	System.out.println(a.toChars(new int[]{1,12,3}));
//    	System.out.println(Alphabet.ASCII.toIndex('a')+","+Alphabet.ASCII.toIndex('A'));
//    	System.out.println(Alphabet.UNICODE16.toIndex('a'));
    	
    	StringBuilder sb= new StringBuilder();
    	Alphabet a = Alphabet.ASCII;
    	for(int i = 0; i<a.radix(); i++){
    		char ch = a.toChar(i);
    		sb.append(ch);
    	}
